...
\begin{tabular}{L!{\VRule}R}
&R\&D in Natural Language Processing $\cdot$ Machine and Deep Learning $\cdot$ Information Retrieval  $\cdot$ Multilingual Data Science, Analytics, and Mining  \vspace{5pt}\\
\end{tabular}
