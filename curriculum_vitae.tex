...
\begin{tabular}{L!{\VRule}R}
	...
	2018& Rosa M. Gim{\'e}nez-P{\'e}rez, M. Franco-Salvador, and P. Rosso. \textbf{String Kernels for Polarity Classification: A Study across Different Languages.}
	In \emph{Proc. of the 23rd International Conference on Natural Language \& Information Systems (NLDB 2018)}, Paris, France, 13-15 June, 2018, pp. n/a. (accepted) \textbf{(CORE C)}\vspace{5pt}\\
	\end{tabular}
	\section*{}
	\begin{tabular}{L!{\VRule}R}
